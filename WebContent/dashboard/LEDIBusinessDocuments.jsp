...
<html class=" js canvas canvastext geolocation crosswindowmessaging no-websqldatabase indexeddb hashchange historymanagement draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow opacity cssanimations csscolumns cssgradients no-cssreflections csstransforms no-csstransforms3d csstransitions  video audio localstorage sessionstorage webworkers applicationcache svg smil svgclippaths   fontface">
    <head>
        ...
        <script type="text/javascript">
            function doOnLoad() {
                ...
                $("#LEdiDocument").addClass("active");
                $("#LEdiDocument").css('font-weight', 'bold');
                $("#LEdiDocument i").addClass("text-red");
    ...
    <body  class="hold-transition skin-blue sidebar-mini" onload="doOnLoad();">
        ...
        <div class="content-wrapper col-sm-12">
            ...
            <s:hidden name="ediDocuments204IB" id="ediDocuments204IB" value="%{ediDocuments204IB}"/>
            <s:hidden name="ediDocuments204OB" id="ediDocuments204OB" value="%{ediDocuments204OB}"/>
            <s:hidden name="ediDocuments990IB" id="ediDocuments990IB" value="%{ediDocuments990IB}"/>
            <s:hidden name="ediDocuments990OB" id="ediDocuments990OB" value="%{ediDocuments990OB}"/>
            <s:hidden name="ediDocuments214IB" id="ediDocuments214IB" value="%{ediDocuments214IB}"/>
            <s:hidden name="ediDocuments214OB" id="ediDocuments214OB" value="%{ediDocuments214OB}"/>
            <s:hidden name="ediDocuments210IB" id="ediDocuments210IB" value="%{ediDocuments210IB}"/>
            <s:hidden name="ediDocuments210OB" id="ediDocuments210OB" value="%{ediDocuments210OB}"/>
...
//204 response OB
                    ...
                    Highcharts.chart('990_RES_LT_IB', {
                        title: {
                            text: '<b>990-Response Load Tender</b>'
                        },
                        chart: {
                            marginRight: 80 // like left
                        },
