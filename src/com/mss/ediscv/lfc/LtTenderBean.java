...
public class LtTenderBean {
    ...
    public LtTenderBean() {
        System.out.println("I am inside LtTenderBean default constructor...");
    }
    ...
    /**
     * @param modFilePath the modFilePath to set
     */
