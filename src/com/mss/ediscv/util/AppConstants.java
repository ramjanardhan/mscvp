...
public class AppConstants {
    ...
    public static final String DB_DRIVERTYPE = "DB_DRIVER_TYPE";
    ...
    public static final String TRANSACTION_SEARCH_LIST="transactionSearchList";
    public static final String SES_DELIVERY_PARTNER_LIST="deliveryChannelPartnerList";
    public static final String SES_DELIVERY_PROCESS_FLOW_GRID="deliveryChannelProcessFlowGrid";
    //Oracle Data Source
    ...
    public static final String PROCESSFLOW_LIST = "processflowList";
    
    //Properties File
    public static final String DB_PROPERTIES_LIST = "appConfigurationsDBList";
    public static final String BASE_VALUE_PROPERTIES_LIST = "appConfigurationsBaseValueList";
    
    public static final String SENDERSID_MAP="senderIdMap";
    public static final String RECEIVERSId_MAP="senderIdMap";
